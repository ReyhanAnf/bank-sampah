...
import { verifikasiSetoranColumns, Setoran } from './verifikasiSetoranColumns';
import { KTCard } from '../../../../_metronic/helpers/components/KTCard';
import { KTIcon } from '../../../../_metronic/helpers';
import { MenuComponent } from '../../../../_metronic/assets/ts/components';

const initialData: Setoran[] = [
  { id: 1, tanggal: '2024-06-01', nasabah: 'Budi', jenis: 'Plastik', berat: '5 kg', nilai: 'Rp 50.000', status: 'Menunggu' },
  { id: 2, tanggal: '2024-06-02', nasabah: 'Siti', jenis: 'Kertas', berat: '3 kg', nilai: 'Rp 30.000', status: 'Disetujui' },
  { id: 3, tanggal: '2024-06-03', nasabah: 'Ahmad', jenis: 'Botol', berat: '2 kg', nilai: 'Rp 20.000', status: 'Menunggu' },
  { id: 4, tanggal: '2024-06-04', nasabah: 'Rina', jenis: 'Kardus', berat: '4 kg', nilai: 'Rp 40.000', status: 'Ditolak' },
];

const VerifikasiSetoranPage = () => {
  ...
  const handleExport = () => {
    const headers = verifikasiSetoranColumns.map(c => c.Header).join(',');
    const rows = filteredData.map(row => 
        verifikasiSetoranColumns.map(col => (row as any)[col.accessor as string]).join(',')
    );
    ...
    a.setAttribute('download', 'verifikasi-setoran.csv');
  ...
  return (
    <div className='container-fluid py-10 px-10'>
      <h1 className='mb-4'>Verifikasi Setoran</h1>
      <KTCard>
        ...
        <div className='card-body'>
          <MetronicTable columns={verifikasiSetoranColumns} data={filteredData} />
        </div>
      </KTCard>
    </div>
  );
...
export default VerifikasiSetoranPage; 