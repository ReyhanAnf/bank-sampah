...
import { riwayatPenarikanColumns, Penarikan } from './riwayatPenarikanColumns';
import { KTCard } from '../../../../_metronic/helpers/components/KTCard';
import { KTIcon } from '../../../../_metronic/helpers';
import { MenuComponent } from '../../../../_metronic/assets/ts/components';

const initialData: Penarikan[] = [
  { id: 1, tanggal: '2024-06-01', nasabah: 'Budi', jumlah: 'Rp 50.000', status: 'Selesai' },
  { id: 2, tanggal: '2024-06-02', nasabah: 'Sari', jumlah: 'Rp 30.000', status: 'Ditolak' },
  { id: 3, tanggal: '2024-06-03', nasabah: 'Ahmad', jumlah: 'Rp 75.000', status: 'Selesai' },
  { id: 4, tanggal: '2024-06-04', nasabah: 'Rina', jumlah: 'Rp 25.000', status: 'Selesai' },
];

const RiwayatPenarikanPage = () => {
  ...
  const handleExport = () => {
    const headers = riwayatPenarikanColumns.map(c => c.Header).join(',');
    const rows = filteredData.map(row => 
        riwayatPenarikanColumns.map(col => (row as any)[col.accessor as string]).join(',')
    );
    ...
    a.setAttribute('download', 'riwayat-penarikan.csv');
  ...
  return (
    <div className='container-fluid py-10 px-10'>
      <h1 className='mb-4'>Riwayat Penarikan</h1>
      <KTCard>
        ...
        <div className='card-body'>
          <MetronicTable columns={riwayatPenarikanColumns} data={filteredData} />
        </div>
      </KTCard>
    </div>
  );
